...
namespace ServiceStack.PartialResponse.ServiceModel
{
    ...
    public static class PartialResponseExtensions
    {
        ...
        /// <param name="request">Servicestack Request Context</param>
        ...
        /// <summary>
        ///     <para>
        ///         Returns a partial response of the given Dto if fields are specified in the request context and the content
        ///         type is supported.
        ///     </para>
